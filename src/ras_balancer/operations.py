...
def extract_row(
    matrix: Union[NDArray, sp.spmatrix], row_index: int
) -> NDArray:
...
def assign_row(
    matrix: Union[NDArray, sp.spmatrix], row_index: int, values: NDArray
) -> None:
